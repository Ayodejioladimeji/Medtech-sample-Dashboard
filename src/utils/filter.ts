...
export const sortUsers = (result, values) => {
  return result?.filter((item) => {
    if (values === "1") {
      return item.isActived;
    } else if (values === "2") {
      return item.isOnboarded;
    } else if (values === "3") {
...
export const sortPerformanceCategory = (result, values) => {
  return result?.filter((item) => {
    if (values === "1") {
      return item.category === "foreign bond";
    } else if (values === "2") {
      return item.category === "foreign equities";
    } else if (values === "3") {
      return item.category === "domestic equities";
    } else {
      return item;
    }
  });
...
export const sortPerformanceTypes = (result, values) => {
  return result?.filter((item) => {
    if (values === "1") {
      return item.currency === "naira";
    } else if (values === "2") {
